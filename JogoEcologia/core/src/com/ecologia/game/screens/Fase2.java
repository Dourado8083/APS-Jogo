...
public class Fase2 extends Fases implements Screen{
	
	private TextureAtlas tAtlas;
	private LevelRenderer level2;

	private JogoEcologia game;
	
	
	public Fase2(JogoEcologia game) {
		this.game = game;
		...
		level2 = new LevelRenderer("2", game);
	...
	public void render(float delta) {
		level2.render(delta, passouFase);
		update(delta);
		}
